...
#  new_home_faq:
    what_programming_languages: "目前支援哪些語言?"
    python_and_javascript: "我們目前支援 Python 以及 JavaScript."
    why_python: "為什麼您該選擇 Python？"
    why_python_blurb: "Python 對於初學者來說很友善，並且被許多大型企業使用（如 Google)。如果您有小孩或您是初學者，我們強烈推薦 Python。"
    why_javascript: "為什麼您該選擇 JavaScript？"
    why_javascript_blurb: "JavaScript i是網路最通用的語言，幾乎所有網站都使用它。如果您學習網站開發，您可以選擇 JavaScript。我們的系統也讓學習者輕鬆的從 Python 轉為 JavaScript-based 網站開發。"
    javascript_versus_python: "JavaScript 的語法相較於 Python 對初學者來說比較困難，所以您如果不知如何選擇，我們建議 Python。"
    how_do_i_get_started: "我該如何開始？"
    getting_started_1: "創建教師帳號"
    getting_started_2: "創建班級"
    getting_started_3: "加入學生"
    getting_started_4: "看著您的學生快樂的學習寫程式"
...
#    teacher_list_resource_hub_3: "for solutions to every level, and the"
    teacher_list_resource_hub_4: "資源中心"
...
#    sec: "sec"
  ...
  play_level:
    ...
    next_level: "下一個關卡："
    combo_challenge: "組合挑戰"
    concept_challenge: "概念挑戰"
    challenge_unlocked: "挑戰已解鎖"
    combo_challenge_unlocked: "組合挑戰已解鎖"
    concept_challenge_unlocked: "概念挑戰已解鎖"
    concept_challenge_complete: "概念挑戰完成！"
    combo_challenge_complete: "組合挑戰完成！"
...
#    practice: "practice"
#    required: "required"
    welcome_to_courses: "冒險者們，歡迎來到課程之中!" # {change}
